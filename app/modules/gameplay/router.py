...
from app.modules.gameplay.schemas import ScenarioCard, ScenarioDetail, ScenarioListResponse
from app.modules.gameplay.service import get_scenario_detail, list_active_scenarios
