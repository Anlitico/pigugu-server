...
async def extract_facts(turns: list[Message], model: str = "qwen-plus") -> list[dict]:
    if not turns:
        return []
...
async def summarize_profile(facts: list[str], *, existing: str = "", model: str = "qwen-plus") -> str:
